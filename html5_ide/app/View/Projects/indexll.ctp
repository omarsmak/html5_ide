<div class="projects index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $project['Project']['project_id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $project['Project']['project_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $project['Project']['project_id']), null, __('Are you sure you want to delete # %s?', $project['Project']['project_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
